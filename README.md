# Lazy_iGrid
One page irregular grid for displaying lots of images with lazy loading.

## Development Environment
Hi there, this project is built by npm and brunch. It's coded oriented to use "modules" and "objects" of HTML and CSS with Jade (pug) and SCSS.
